...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool MixedRealityCameraSystem_get_IsOpaque_m12A87563BEB7B7A6D4F9B7992F0F3119E439B87A (MixedRealityCameraSystem_t6C83CBAC4C6A8947612E6CE8C0D24DDB8A0A9B5C * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_3);
		RuntimeObject* L_4 = InterfaceFuncInvoker1< RuntimeObject*, int32_t >::Invoke(0 /* !0 System.Collections.Generic.IReadOnlyList`1<Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSettingsProvider>::get_Item(System.Int32) */, IReadOnlyList_1_tAF83D3E68C1B8F2ABF731862DB58B3951B8B1AAE_il2cpp_TypeInfo_var, L_3, 0);
		NullCheck(L_4);
...
IL_004a:
	{
		NullCheck(G_B5_0);
		Type_t * L_12 = SystemType_get_Type_m43909FABC539AB0844952D8982A00FF0EDB618CA_inline(G_B5_0, /*hidden argument*/NULL);
		G_B6_0 = L_12;
	}
...
IL_004f:
	...
	}
	{
		...
		String_t* L_17 = MixedRealityCameraSettingsConfiguration_get_ComponentName_mDBC3C0470A700C8CB41A2DDF98136AF07D56570E_inline((MixedRealityCameraSettingsConfiguration_t1A0F279A8A973F926FFEBB526B697F2BA994CCBA *)(&V_2), /*hidden argument*/NULL);
		NullCheck(L_16);
		...
		uint32_t L_19 = MixedRealityCameraSettingsConfiguration_get_Priority_m5AE6E3DCA081EC6444EA4203429AE11D410B38C4_inline((MixedRealityCameraSettingsConfiguration_t1A0F279A8A973F926FFEBB526B697F2BA994CCBA *)(&V_2), /*hidden argument*/NULL);
		uint32_t L_20 = L_19;
		...
		NullCheck(L_24);
		Type_t * L_25 = SystemType_get_Type_m43909FABC539AB0844952D8982A00FF0EDB618CA_inline(L_24, /*hidden argument*/NULL);
		...
		bool L_28 = BaseDataProviderAccessCoreSystem_RegisterDataProvider_TisIMixedRealityCameraSettingsProvider_t00757F5943FA05F77C2D1E4C44072C9D31C1DDF7_m6C87B030EBE2CD9EA9B9ED09B5699B3069A2BF05(__this, L_25, L_26, L_27, /*hidden argument*/BaseDataProviderAccessCoreSystem_RegisterDataProvider_TisIMixedRealityCameraSettingsProvider_t00757F5943FA05F77C2D1E4C44072C9D31C1DDF7_m6C87B030EBE2CD9EA9B9ED09B5699B3069A2BF05_RuntimeMethod_var);
		if (!L_28)
		{
			goto IL_00b9;
		}
	}
	{
		...
		String_t* L_29 = MixedRealityCameraSettingsConfiguration_get_ComponentName_mDBC3C0470A700C8CB41A2DDF98136AF07D56570E_inline((MixedRealityCameraSettingsConfiguration_t1A0F279A8A973F926FFEBB526B697F2BA994CCBA *)(&V_2), /*hidden argument*/NULL);
		RuntimeObject* L_30 = GenericVirtFuncInvoker1< RuntimeObject*, String_t* >::Invoke(BaseDataProviderAccessCoreSystem_GetDataProvider_TisIMixedRealityCameraSettingsProvider_t00757F5943FA05F77C2D1E4C44072C9D31C1DDF7_mBD78922E37A3F7B12DC5C70E0929383DC3B13B8D_RuntimeMethod_var, __this, L_29);
...
IL_00cb:
	{
		...
		RuntimeObject* L_36 = GenericVirtFuncInvoker0< RuntimeObject* >::Invoke(BaseDataProviderAccessCoreSystem_GetDataProviders_TisIMixedRealityCameraSettingsProvider_t00757F5943FA05F77C2D1E4C44072C9D31C1DDF7_m21CD50ECD539A7206CFACDA5808A820492988EB9_RuntimeMethod_var, __this);
		NullCheck(L_36);
		int32_t L_37 = InterfaceFuncInvoker0< int32_t >::Invoke(0 /* System.Int32 System.Collections.Generic.IReadOnlyCollection`1<Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSettingsProvider>::get_Count() */, IReadOnlyCollection_1_tCF701ED7382EE1C81D01DEF3FABD270BD1763A36_il2cpp_TypeInfo_var, L_36);
	...
	}
	{
		...
		bool L_39 = MixedRealityCameraSystem_get_IsOpaque_m12A87563BEB7B7A6D4F9B7992F0F3119E439B87A(__this, /*hidden argument*/NULL);
		__this->set_cameraOpaqueLastFrame_21(L_39);
		// if (IsOpaque)
		bool L_40 = MixedRealityCameraSystem_get_IsOpaque_m12A87563BEB7B7A6D4F9B7992F0F3119E439B87A(__this, /*hidden argument*/NULL);
		if (!L_40)
		{
			goto IL_0106;
		}
...
IL_010c:
	{
		...
		MixedRealityPlayspace_set_Position_m4C9A22BC7CA46A05A672177418482F60903BC1BA(L_41, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_set_Rotation_m9C2BAE234B7A72AEEA82B15EC06B86B21DA861BF(L_42, /*hidden argument*/NULL);
	...
	{ // begin try (depth: 1)
		{
			...
			bool L_3 = MixedRealityCameraSystem_get_IsOpaque_m12A87563BEB7B7A6D4F9B7992F0F3119E439B87A(__this, /*hidden argument*/NULL);
...
IL_0025:
		{
			// cameraOpaqueLastFrame = IsOpaque;
			bool L_5 = MixedRealityCameraSystem_get_IsOpaque_m12A87563BEB7B7A6D4F9B7992F0F3119E439B87A(__this, /*hidden argument*/NULL);
			__this->set_cameraOpaqueLastFrame_21(L_5);
			// if (IsOpaque)
			bool L_6 = MixedRealityCameraSystem_get_IsOpaque_m12A87563BEB7B7A6D4F9B7992F0F3119E439B87A(__this, /*hidden argument*/NULL);
			if (!L_6)
			{
				goto IL_0041;
			}
